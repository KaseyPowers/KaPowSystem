...
export type PartialRequired<T extends Object, K extends keyof T> = Omit<T, K> & Required<Pick<T, K>>;

export type PartialPartial<T extends Object, K extends keyof T> = Omit<T, K> & Partial<Pick<T, K>>;
